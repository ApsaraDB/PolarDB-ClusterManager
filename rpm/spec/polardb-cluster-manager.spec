...
#软件包的名字
Name: polardb-clustermanager
#软件包的主版本号
Version: 1.0.0
#软件包的次版本号
Release: PolarDBRelease
...
cp -f /root/polardb-cluster-manager ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/polardb-cluster-manager
cp -f /root/polardb_cluster_manager_control.py ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/polardb_cluster_manager_control.py
cp -f /root/supervisor.py ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/supervisor.py

mkdir -p ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/plugin/manager
cp -f /root/manager.so ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/plugin/manager/manager.so
cp -f /root/manager_extern.conf ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/plugin/manager/manager_extern.conf
cp -f /root/plugin_golang_manager.conf ${RPM_BUILD_ROOT}/usr/local/polardb_cluster_manager/bin/plugin/plugin_golang_manager.conf
